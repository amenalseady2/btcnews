                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            ...
                            <form class="form-horizontal" action="/admin/version/{{ $row->id}}" method="post" id="bookForm" >
                                {{ method_field('PUT') }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 col-md-3 col-lg-2">
                                        <select name="status" id="status" class="form-control">
                                            <option value="0" @if($row->status == 0) SELECTED @endif>不更新</option>
                                            <option value="1" @if($row->status == 1) SELECTED @endif>选择更新</option>
                                            <option value="2" @if($row->status == 2) SELECTED @endif>强制更新</option>
                                        </select>
                                    </div>
                                </div>
